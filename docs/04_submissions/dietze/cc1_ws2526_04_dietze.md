...
*Submission:
used it in the beginning to directly look a specific lines of code or tell me about errors.
...
What I use (not in this example but in working for my final submission):
Gemini to create a project plan and split up tasks  Recommending Approaches and ChatGPT + Claude to fix/ inspect code and recommend different solutions. 
...
Be careful. When I worked with an AI and gave it some of my code, I got a working version back but for me it was way less comprehensive. So sometimes when fixing your code the AI optimizes it to a point you lose control and can no longer work on it without the help of the AI.
(This has been partialy the case in this submission.)
